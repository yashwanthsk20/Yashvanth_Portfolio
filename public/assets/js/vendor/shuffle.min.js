...
! function(t, e) {
    ...
    function D(t, e) {
        ...
        return t.addEventListener("transitionend", n), w[i] = {
            element: t,
            listener: n
        }, i
    }
    ...
    var N = 0,
        H = function(e) {
            ...
            function u(e) {
                ...
                t(this, u), (i = a.call(this)).options = Object.assign({}, u.options, n), i.options.delimeter && (i.options.delimiter = i.options.delimeter), i.lastSort = {}, i.group = u.ALL_ITEMS, i.lastFilter = u.ALL_ITEMS, i.isEnabled = !0, i.isDestroyed = !1, i.isInitialized = !1, i._transitions = [], i.isTransitioning = !1, i._queue = [];
            ...
            return i(u, [{
                key: "_init",
                value: function() {
                    if (this.items = this._getItems(), this.options.sizer = this._getElementOption(this.options.sizer), this.element.classList.add(u.Classes.BASE), this._initItems(this.items), this._onResize = this._getResizeFunction(), window.addEventListener("resize", this._onResize), "complete" !== document.readyState) {
                ...
                value: function(t, e) {
                    var i = this,
                        n = [],
                        s = [];
                    return t === u.ALL_ITEMS ? n = e : e.forEach((function(e) {
                ...
                value: function(t, e) {
                    var i;
                    return 0 === (i = "function" == typeof this.options.columnWidth ? this.options.columnWidth(t) : this.options.sizer ? u.getSize(this.options.sizer).width : this.options.columnWidth ? this.options.columnWidth : this.items.length > 0 ? u.getSize(this.items[0].element, !0).width : t) && (i = t), i + e
                }
            }, {
                key: "_getGutterSize",
                value: function(t) {
                ...
                value: function(t) {
                    return function(t) {
                        for (var e = t.itemSize, i = t.positions, n = t.gridSize, s = t.total, o = t.threshold, r = t.buffer, l = M(e.width, n, s, o), a = A(i, l, s), u = F(a, r), h = new v(n * u, a[u]), f = a[u] + e.height, c = 0; c < l; c++) i[u + c] = f;
                        return h
                    }({
                        itemSize: t,
                ...
                value: function() {
                    ...
                    e && t && this.isInitialized ? this._startTransitions(this._queue) : e ? (this._styleImmediately(this._queue), this._dispatch(u.EventType.LAYOUT)) : this._dispatch(u.EventType.LAYOUT), this._queue.length = 0
                }
            }, {
                ...
                value: function(t) {
                    ...
                    if (t.length) {
                        ...
                        this._toggleFilterClasses({
                            ...
                            return !n.includes(t)
                        })), this._updateItemCount(), this.once(u.EventType.LAYOUT, (function() {
                            e._disposeItems(n), i.forEach((function(t) {
                                t.parentNode.removeChild(t)
                            })), e._dispatch(u.EventType.REMOVED, {
                                collection: i
                            })
                        }))
                    }
                ...
                value: function() {
                    var t = this;
                    this._disposeItems(this.items), this.isInitialized = !1, this.items = this._getItems(), this._initItems(this.items), this.once(u.EventType.LAYOUT, (function() {
    ...
    return H.ShuffleItem = E, H.ALL_ITEMS = "all", H.FILTER_ATTRIBUTE_KEY = "groups", H.EventType = {
        LAYOUT: "shuffle:layout",
        REMOVED: "shuffle:removed"
    }, H.Classes = g, H.FilterMode = {
        ANY: "any",
        ALL: "all"
    }, H.options = {
        group: H.ALL_ITEMS,
        ...
        isCentered: !1,
        roundTransforms: !0
    }, H.Point = v, H.Rect = y, H.__sorter = k, H.__getColumnSpan = M, H.__getAvailablePositions = A, H.__getShortColumn = F, H.__getCenteredPositions = x, H
}));